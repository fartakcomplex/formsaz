...
export default function UserPanel() {
  ...
  if (loading) {
    return (
      <div dir="rtl" className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-950">
  ...
  return (
    <div dir="rtl" className="min-h-screen bg-gray-50 dark:bg-gray-950 flex">
      {/* Sidebar */}
      <aside className="w-72 bg-white dark:bg-gray-900 border-l border-gray-200 dark:border-gray-800 flex flex-col h-screen sticky top-0">
        {/* Gradient accent */}
              ...
              <CardContent className="p-6 space-y-4">
                <div className="flex items-center gap-4 mb-6">
                  <div className="relative">
                    ...
                    <button className="absolute -bottom-1 -left-1 w-7 h-7 bg-white dark:bg-gray-800 rounded-full flex items-center justify-center shadow-md border border-gray-200 dark:border-gray-700">
                ...
                {isEditing ? (
                  <div className="grid gap-4">
                    ...
                    <div className="grid gap-2">
                      ...
                      <textarea className="flex min-h-[100px] w-full rounded-xl border border-gray-200 dark:border-gray-800 bg-transparent px-4 py-3 text-sm" value={editBio} onChange={e => setEditBio(e.target.value)} placeholder="یک جمله درباره خودتان..." />
                    </div>
                  </div>
                ) : (
                  <div className="grid gap-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <Card className="rounded-2xl">
                <CardContent className="p-5 text-center">
                  ...
                  <div className="text-2xl font-bold">{profile?.formCount || 0}</div>
              ...
              <Card className="rounded-2xl">
                <CardContent className="p-5 text-center">
                  ...
                  <div className="text-2xl font-bold">{profile?.notificationCount || 0}</div>
              ...
              <Card className="rounded-2xl">
                <CardContent className="p-5 text-center">
                  ...
                  <div className="text-2xl font-bold">{profile?.role === 'admin' ? 'مدیر' : 'کاربر'}</div>
